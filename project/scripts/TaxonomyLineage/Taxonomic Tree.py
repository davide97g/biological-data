from ete3 import NCBITaxa, TreeStyle, Tree, AttrFace, faces, CircleFace, TreeFace
...
with open('data/Family Sequences/Taxonomic/taxonomic_lin.txt') as f:
    next(f)
    for line in f:
...
tree.render("data/Family Sequences/Taxonomic/tree.jpg", w=1980, tree_style=ts)
